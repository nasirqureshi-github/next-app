  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/10 backdrop-blur-xs flex justify-center items-center z-50">
      <div className=" bg-white p-6 rounded-lg w-80 md:w-96 ">
        ...
        <input type="text" placeholder="Name" required className=" text-black w-full mb-3 p-2 border border-black/20 outline-lime-400 rounded"/>
        ...
        <button className="bg-lime-400 text-black px-4 py-2 rounded w-full cursor-pointer">Sign up</button>
